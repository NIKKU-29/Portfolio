        ...
        document.querySelectorAll('a[href^="#projects"], a[href^="#contact-main"]').forEach(link => {
            ...
            link.addEventListener('click', function (event) {
                ...
                const targetId = link.getAttribute('href'); // Get the href attribute (e.g., "#projects" or "#contact-main")
